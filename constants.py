...
acceptable_locations :list[str] = ["Eatontown", "Edison", "Freehold", "Rahway", "South Plainfield"]
acceptable_year :int = 2025
acceptable_month :list[int] = [4,5,6]
acceptable_weekday :list[int] = [0,1,2,3,4,5,6] #Monday 0, Sunday 6
acceptable_hour :list[int] = [8,9,10,11,12,13,14,15,16] #hour in 24H format
